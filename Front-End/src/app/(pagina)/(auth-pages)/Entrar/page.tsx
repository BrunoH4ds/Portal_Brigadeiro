import ButtonsTypeAccount from "@/components/comp_login/ButtonsTypeAccount";
import InputsCadAndLogin from "@/components/comp_login/InputsCadAndLogin";
    ...
    <div className="flex flex-1 justify-center items-center mt-28 mb-8">
      <div className="flex flex-col w-4/5 md:w-2/3 lg:w-auto justify-center items-center border border-blue-900 bg-zinc-50/50 backdrop-blur-sm p-5 rounded-md">
        ...
        <div className="flex flex-col justify-center items-center w-full">
          ...
          <ButtonsTypeAccount />
          <button className="mt-2 w-4/5 p-2 rounded-md bg-blue-900 hover:bg-blue-800 text-white">
            Entrar
          </button>
        </div>
      </div>
