...
import NewsList from "@/components/comp_admin/comp_news/NewsList";
import NewsModal from "@/components/comp_admin/comp_news/NewsModal";
...
export default function NewsAdmin() {
  ...
  const handleAddNews = () => {
    ...
    setMessage("");
    setShowModal(false);
    alert(editingId ? "Notícia atualizada com sucesso!" : "Notícia adicionada com sucesso!");
  };
  ...
  return (
    <div>
      ...
      {/* Modal de Adicionar/Editar Notícia */}
      <NewsModal
        showModal={showModal}
