export default function Methodology() {
  return (
    <section
      className="flex flex-col items-center lg:flex-row justify-around p-5 gap-10 bg-blend-darken bg-cover "
      style={{
        backgroundImage: `url("https://programapleno.com.br/wp-content/uploads/2022/07/Metodologia-educacional-quais-os-tipos-e-suas-particularidades-1300x731.jpg")`, // Usa a URL da imagem recebida via props
